export const onboardingSwiperData: onboardingSwiperDataType[] = [
	{
		...
		shortDescription: "your curiosity & enjoyable.",
	...
	},
	{
		...
		shortDescription: "instructors to guide every step.",
	...
	},
	{
		...
		shortDescription: "typically need to complete the required",
		shortDescription2: "coursework & assessments.",
